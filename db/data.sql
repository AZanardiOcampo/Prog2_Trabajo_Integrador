...
(default, "campodejuego", "campodejuego@gmail.com", "https://i.pinimg.com/originals/df/4f/9f/df4f9f97d31c38cdd05bdbc6f5c6df0b.jpg", "$2a$10$g.9br4i7FJ7jdDwI8mYu5umEfRy9NWGb2BPtodJ3RCbJtCD9Tg.BO", "2012-01-06", 47928032),
...
(default, 2, 7, "Vamos Santos !!!!!"), /* el usuario 2 comenta en el posteo 1 (que es del usuario 1), ese comentario */
(default, 3, 7, "Te amo Neymar !!!!!"),
(default, 4, 7, "La copa libertadores es mi obsesion"),
(default, 5, 7, "Que Jogadorrrr..."),
/* ROMAN */ /* SEGUNDO POSTEO DE USUARIO 1 */
(default, 2, 10, "EL ULTIMO 10"),
(default, 3, 10, "Roman, Boca es tu casa"),
(default, 4, 10, "QUIERO LA LIBERTADOOOREEEEE"),
(default, 5, 10, "Romanticoooo"),
/* BICHO */ /* PRIMER POSTEO DE USUARIO 2 */
(default, 1, 2, "THE GOAT"),
(default, 3, 2, "Mr. Championsss"), 
(default, 4, 2, "EL COMANDANTEEEE"), 
(default, 5, 2, "Messi > Ronaldo"),
/* DINHO */ /* SEGUNDO POSTEO DE USUARIO 2 */
(default, 1, 5, "Zaaambaaaaa"),
(default, 3, 5, "The magician"), 
(default, 4, 5, "Futeboolll"), 
(default, 5, 5, "Baila Dinho Baila"),
/* MESSI */ /* PRIMER POSTEO DE USUARIO 3 */
(default, 1, 6, "THE GOAT"),
(default, 2, 6, "Muchaaaachooosssss"),
(default, 4, 6, "Ronaldo > Messi"),
(default, 5, 6, "HERMOSAAAAA"),
/* NEY CHAMPIONS */ /* SEGUNDO POSTEO DE USUARIO 3  */
(default, 1, 8, "Visca Barca"),
(default, 2, 8, "Volveeeeee"),
(default, 4, 8, "Neymar Barcelona > Neymar PSG"),
(default, 5, 8, "Campeonesssss"),
/* VENEZUELA */ /* PRIMER POSTEO DE USUARIO 4 */
(default, 1, 1, "Grande Josefff!!!!!"),
(default, 2, 1, "Idoloooo"),
(default, 3, 1, "Vamos seleccioooonnnn"),
(default, 5, 1, "Vinotiintooooo"),
/* DIBU */ /* SEGUNDO POSTEO DE USUARIO 4*/
(default, 1, 4, "SIIIIII"),
(default, 2, 4, "Dibujeeeeee"),
(default, 3, 4, "LO SIENTO PERO TE COMO HERMANO"),
(default, 5, 4, "Genioooooo"),
...
(default, 1, 3, "Vamos LEOOOOO"),
(default, 2, 3, "El mejor de todos los tiempos"),
(default, 3, 3, "COME ON MESSIIIII"),
(default, 4, 3, "The Last Dance")
;